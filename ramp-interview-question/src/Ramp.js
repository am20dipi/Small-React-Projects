...
// There are three types of input: 
    // 1. If the prop is a falsy value, return a live-updating date 
        // and time (update every second) in a div. Please pretty-format 
        // the date and time. Use the native JavaScript Date object.
